<template>
  <div class="container">
    ...
    <div class="form-container">
      ...
      <div class="introduce">登录</div>
      <div class="form-container-body">
        <div class="login-form">
          <el-form ref="loginFormRef" :model="loginForm" :rules="loginFormRules" style="width: 208px">
  ...
  .ball {
    ...
    .support {
      ...
      @keyframes translateShadow {
        0% {
          box-shadow: 40px 40px 10px #446;
          transform: translateY(0);
        }

        100% {
          box-shadow: 40px 350px 250px #446;
