    ...
    <el-card style="max-width: 100%">
      <el-descriptions title="项目信息" :column="4" border>
        <el-descriptions-item>
          <template #label> <span>当前版本</span> </template>
          <el-tag>0.0.1</el-tag>
        </el-descriptions-item>
        <el-descriptions-item>
          <template #label><span>最后编译时间</span> </template>
          <el-tag>{{ time }}</el-tag>
        </el-descriptions-item>
        <el-descriptions-item>
          <template #label><span>node 版本建议</span> </template>
          <el-tag>>=18.16.0</el-tag>
        </el-descriptions-item>
        <el-descriptions-item>
          <template #label><span>pnpm 版本建议</span> </template>
          <el-tag>>=8.15.0</el-tag>
        </el-descriptions-item>
        <el-descriptions-item>
          <template #label><span>开发人员</span> </template>
          <el-tag>张三</el-tag>
          <el-tag class="ml-2">李四</el-tag>
        </el-descriptions-item>
        <el-descriptions-item>
          <template #label><span>代码仓库</span> </template>
          <el-link type="primary" href="https://github.com/kun-js/vue-kun-admin" target="_blank"> Github </el-link>
        </el-descriptions-item>
        <el-descriptions-item>
          <template #label> <span>预览地址</span> </template>
  ...
  <div class="personal-info-container">
    <el-card style="max-width: 100%">
      <el-descriptions title="个人介绍" :column="3" border>
        <el-descriptions-item>
          <template #label> <span>姓名</span> </template>
          <el-tag>张三</el-tag>
        </el-descriptions-item>
        <el-descriptions-item>
          <template #label><span>年龄</span> </template>
          <el-tag>18</el-tag>
        </el-descriptions-item>
        <el-descriptions-item>
          <template #label> <span>地区</span> </template>
          <el-tag>深圳</el-tag>
        </el-descriptions-item>
        <el-descriptions-item>
          <template #label><span>已当社畜</span> </template>
          <el-tag>5年</el-tag>
        </el-descriptions-item>
        <el-descriptions-item>
          <template #label><span>熟悉语言</span> </template>
        ...
        <el-descriptions-item>
          <template #label><span>兴趣爱好</span> </template>
          🏀 ⚽ 🎳 🏓 🏸 🎱 🎣
        </el-descriptions-item>
        <el-descriptions-item>
          <template #label><span>个人简介</span> </template>
