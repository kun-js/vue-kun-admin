<template>
  <el-card style="max-width: 100%; height: 100%">
    ...
    <el-progress :percentage="90" :stroke-width="15" striped striped-flow>
      <span>周六</span>
    </el-progress>
    <el-progress :percentage="75" :stroke-width="15" striped striped-flow>
      <span>周五</span>
    </el-progress>
    ...
    <el-progress :percentage="20" :stroke-width="15" status="exception" striped striped-flow>
      <span>周二</span>
    </el-progress>
    <el-progress :percentage="10" :stroke-width="15" status="exception" striped striped-flow>
      <span>周一</span>
    </el-progress>
  </el-card>
</template>
